...
public static class ApplicationStage
{
	...
	public static List<(string Title, Func<Task> Action, Func<bool> Condition)> GetActions(IStatusReporter reporter = null, ApplicationSelection selection = null)
	{
		...
		var actions = new List<(string Title, Func<Task> Action, Func<bool> Condition)>
		{
			...
			("Installing StartAllBack", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\StartIsBack", "AutoUpdates", 0, RegistryValueKind.DWord), () => selection == null),
			("Installing StartAllBack", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\StartIsBack", "SettingsVersion", 6, RegistryValueKind.DWord), () => selection == null),
			("Installing StartAllBack", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\StartIsBack", "WelcomeShown", 3, RegistryValueKind.DWord), () => selection == null),
			("Installing StartAllBack", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\StartIsBack", "FrameStyle", 0, RegistryValueKind.DWord), () => selection == null),
			("Installing StartAllBack", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\StartIsBack", "WinkeyFunction", 1, RegistryValueKind.DWord), () => selection == null),
			("Installing StartAllBack", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\StartIsBack", "LegacyTaskbar", 0, RegistryValueKind.DWord), () => selection == null),
			("Installing StartAllBack", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\StartIsBack", "DriveGrouping", 1, RegistryValueKind.DWord), () => selection == null),
			...
			("Installing Autoruns", async () => ShortcutHelper.Create(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData), @"Microsoft\Windows\Start Menu\Programs\Autoruns.lnk"), Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ProgramFiles), "Autoruns", "Autoruns64.exe")), () => selection == null),
			...
			("Installing Process Explorer", async () => ShortcutHelper.Create(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData), @"Microsoft\Windows\Start Menu\Programs\Process Explorer.lnk"), Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ProgramFiles), "Process Explorer", "procexp64.exe")), () => selection == null),
			...
			// install zentimings
			("Installing ZenTimings", async () => await ExtractHelper.Extract(Path.Combine(Path.GetTempPath(), "ZenTimings.zip"), Path.Combine(Path.GetTempPath(), "ZenTimings_temp")), () => ZenTimings == true),
			("Installing ZenTimings", async () => Directory.Move(Path.Combine(Path.GetTempPath(), "ZenTimings_temp", "ZenTimings_v1.39"), Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ProgramFiles), "ZenTimings")), () => ZenTimings == true),
			("Installing ZenTimings", async () => await ProcessActions.RunPowerShell(@"$Shell = New-Object -ComObject WScript.Shell; $Shortcut = $Shell.CreateShortcut([System.IO.Path]::Combine($env:ProgramData, 'Microsoft\Windows\Start Menu\Programs\ZenTimings.lnk')); $Shortcut.TargetPath = [System.IO.Path]::Combine($env:ProgramFiles, 'ZenTimings\ZenTimings.exe'); $Shortcut.Save()"), () => ZenTimings == true),
			...
			("Installing OCCT", async () => await ProcessActions.RunPowerShell(@"$Shell = New-Object -ComObject WScript.Shell; $Shortcut = $Shell.CreateShortcut([System.IO.Path]::Combine($env:ProgramData, 'Microsoft\Windows\Start Menu\Programs\OCCT.lnk')); $Shortcut.TargetPath = [System.IO.Path]::Combine($env:ProgramFiles, 'OCCT\OCCT.exe'); $Shortcut.Save()"), () => OCCT == true),
			...
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\Common\ClientTelemetry", "DisableTelemetry", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\Common\ClientTelemetry", "SendTelemetry", 3, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Common", "qmenable", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Common", "sendcustomerdata", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Common", "updatereliabilitydata", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Common", "linkedin", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Common\General", "disablecomingsoon", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Common\General", "optindisable", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Common\General", "shownfirstrunoptin", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Common\General", "ShownFileFmtPrompt", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Common\General", "skydrivesigninoption", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Common\Feedback", "enabled", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Common\Feedback", "includescreenshot", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Common\Feedback", "includeemail", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Common\Feedback", "surveyenabled", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Common\Internet", "useonlinecontent", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Common\PTWatson", "PTWOptIn", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Common\Privacy", "disconnectedstate", 2, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Common\Privacy", "usercontentdisabled", 2, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Common\Privacy", "downloadcontentdisabled", 2, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Common\Privacy", "controllerconnectedservicesenabled", 2, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Common\Security\FileValidation", "disablereporting", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Firstrun", "BootedRTM", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Firstrun", "disablemovie", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Lync", "disableautomaticsendtracing", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Outlook\Options\Mail", "EnableLogging", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Word\Options", "EnableLogging", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\OSM", "Enablelogging", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\OSM", "EnableUpload", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\OSM\PreventedApplications", "accesssolution", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\OSM\PreventedApplications", "olksolution", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\OSM\PreventedApplications", "onenotesolution", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\OSM\PreventedApplications", "pptsolution", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\OSM\PreventedApplications", "projectsolution", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\OSM\PreventedApplications", "publishersolution", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\OSM\PreventedApplications", "visiosolution", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\OSM\PreventedApplications", "wdsolution", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\OSM\PreventedApplications", "xlsolution", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\OSM\PreventedSolutiontypes", "agave", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\OSM\PreventedSolutiontypes", "appaddins", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\OSM\PreventedSolutiontypes", "comaddins", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\OSM\PreventedSolutiontypes", "documentfiles", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\OSM\PreventedSolutiontypes", "templatefiles", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\Common\ClientTelemetry", "SendTelemetry", 3, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\Common", "qmenable", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\Common", "sendcustomerdata", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\Common", "updatereliabilitydata", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\Common", "linkedin", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\Common\General", "disablecomingsoon", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\Common\General", "optindisable", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\Common\General", "shownfirstrunoptin", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\Common\General", "ShownFileFmtPrompt", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\Common\General", "skydrivesigninoption", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\Common\Feedback", "enabled", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\Common\Feedback", "includescreenshot", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\Common\Feedback", "includeemail", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\Common\Feedback", "surveyenabled", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\Common\Internet", "useonlinecontent", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\Common\PTWatson", "PTWOptIn", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\Common\Privacy", "disconnectedstate", 2, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\Common\Privacy", "usercontentdisabled", 2, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\Common\Privacy", "downloadcontentdisabled", 2, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\Common\Privacy", "controllerconnectedservicesenabled", 2, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			...
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\Firstrun", "BootedRTM", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\Firstrun", "disablemovie", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\Lync", "disableautomaticsendtracing", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\Outlook\Options\Mail", "EnableLogging", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\Word\Options", "EnableLogging", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\OSM", "Enablelogging", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\OSM", "EnableUpload", 0, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\OSM\PreventedApplications", "accesssolution", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\OSM\PreventedApplications", "olksolution", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\OSM\PreventedApplications", "onenotesolution", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\OSM\PreventedApplications", "pptsolution", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			...
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\OSM\PreventedApplications", "publishersolution", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\OSM\PreventedApplications", "visiosolution", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\OSM\PreventedApplications", "wdsolution", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\OSM\PreventedApplications", "xlsolution", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\OSM\PreventedSolutiontypes", "agave", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\OSM\PreventedSolutiontypes", "appaddins", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\OSM\PreventedSolutiontypes", "comaddins", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\OSM\PreventedSolutiontypes", "documentfiles", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
			("Disabling Office telemetry", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\16.0\OSM\PreventedSolutiontypes", "templatefiles", 1, RegistryValueKind.DWord), () => Word == true || Excel == true || PowerPoint == true || OneNote == true || Teams == true || Outlook == true || OneDrive == true),
