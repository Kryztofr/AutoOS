...
public static class ApplicationStage
{
	...
	public static List<(string Title, Func<Task> Action, Func<bool> Condition)> GetActions(IStatusReporter reporter = null, ApplicationSelection selection = null)
	{
		...
		var actions = new List<(string Title, Func<Task> Action, Func<bool> Condition)>
		{
			...
			("Installing Process Explorer", async () => await Process.Start(new ProcessStartInfo { FileName = "reg.exe", Arguments = $@"load HKU\DefaultUser ""{Path.Combine(Path.GetPathRoot(Environment.SystemDirectory)!, "Users", "Default", "NTUSER.DAT")}""", CreateNoWindow = true })!.WaitForExitAsync(), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer", "EulaAccepted", 1, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer", "Windowplacement", new byte[] { 0x2c, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x68, 0x00, 0x00, 0x00, 0x68, 0x00, 0x00, 0x00, 0x08, 0x06, 0x00, 0x00, 0x59, 0x03, 0x00, 0x00 }, RegistryValueKind.Binary, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer", "ConfirmKill", 0, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer", "PrcessColumnCount", 13, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer", "DllColumnCount", 4, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer", "HandleColumnCount", 2, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer", "TrayCPUHistory", 0, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer", "ProcessImageColumnWidth", 280, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\DllColumnMap", "0", 26, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\DllColumnMap", "1", 42, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\DllColumnMap", "2", 1033, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\DllColumnMap", "3", 1111, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\DllColumns", "0", 110, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\DllColumns", "1", 180, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\DllColumns", "2", 140, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\DllColumns", "3", 300, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\HandleColumnMap", "0", 21, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\HandleColumnMap", "1", 22, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\HandleColumns", "0", 100, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\HandleColumns", "1", 450, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumnMap", "0", 3, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumnMap", "1", 1055, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumnMap", "2", 1060, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumnMap", "3", 1063, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumnMap", "4", 1650, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumnMap", "5", 4, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumnMap", "6", 38, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumnMap", "7", 1033, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumnMap", "8", 1200, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumnMap", "9", 1092, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumnMap", "10", 5, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumnMap", "11", 1065, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumnMap", "12", 18, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumnMap", "13", 18, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumnMap", "14", 1087, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumnMap", "15", 1195, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumns", "0", 200, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumns", "1", 60, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumns", "2", 84, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumns", "3", 80, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumns", "4", 39, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumns", "5", 44, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumns", "6", 257, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumns", "7", 181, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumns", "8", 100, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumns", "9", 100, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumns", "10", 100, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumns", "11", 100, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => RegistryHelper.SetValue(RegistryHelper.Identity.CurrentUser, @"HKEY_CURRENT_USER\Software\Sysinternals\Process Explorer\ProcessColumns", "12", 100, RegistryValueKind.DWord, true), () => selection == null),
			("Installing Process Explorer", async () => await Process.Start(new ProcessStartInfo { FileName = "reg.exe", Arguments = @"unload HKU\DefaultUser", CreateNoWindow = true })!.WaitForExitAsync(), () => selection == null),
			...
			// download rustdesk
			("Downloading RustDesk", async () => await DownloadHelper.Download("https://github.com/rustdesk/rustdesk/releases/download/1.4.7/rustdesk-1.4.7-x86_64.msi", Path.GetTempPath(), "rustdesk.msi", reporter: reporter), () => RustDesk == true),

			// install rustdesk
			("Installing RustDesk", async () => await Process.Start(new ProcessStartInfo { FileName = "msiexec.exe", Arguments = $@"/i ""{Path.Combine(Path.GetTempPath(), "rustdesk.msi")}"" /qn" , WindowStyle = ProcessWindowStyle.Hidden })!.WaitForExitAsync(), () => RustDesk == true),
			("Cleaning up RustDesk files", async () => File.Delete(Path.Combine(Path.GetTempPath(), "rustdesk.msi")), () => RustDesk == true),
