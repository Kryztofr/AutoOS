...
public sealed partial class ApplicationsPage : Page
{
	...
	private void GetItems()
	{
		...
		var launchersList = new List<GridViewItem>
		{
			...
			new() { Text = "NoRisk Client", ImageSource = "ms-appx:///Assets/Fluent/NoRiskClient.png", IsInstalled = File.Exists(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "NoRisk Launcher", "noriskclient-launcher-v3.exe")) },
