...
public static class GraphicsStage
{
    ...
    public static async Task Run()
    {
        ...
        var actions = new List<(string Title, Func<Task> Action, Func<bool> Condition)>
        {
            ...
            ("Installing OBS Studio", async () => iniHelper.AddValue("Encoder", "obs_qsv11_v2", "AdvOut"), () => NVIDIA == false && (Intel_6th == true || Intel_7th_10th == true || Intel_11th_14th == true || Intel_Arc == true)),
            ("Installing OBS Studio", async () => iniHelper.AddValue("RecEncoder", "obs_qsv11_v2", "AdvOut"), () => NVIDIA == false && (Intel_6th == true || Intel_7th_10th == true || Intel_11th_14th == true || Intel_Arc == true)),
            ("Installing OBS Studio", async () => iniHelper.AddValue("Encoder", "h264_texture_amf", "AdvOut"), () => NVIDIA == false && AMD_RX5000_RX9000 == true),
            ("Installing OBS Studio", async () => iniHelper.AddValue("RecEncoder", "h264_texture_amf", "AdvOut"), () => NVIDIA == false &&  AMD_RX5000_RX9000 == true),
