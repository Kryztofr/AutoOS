...
public static class PowerStage
{
    ...
    public static async Task Run()
    {
        ...
        var actions = new List<(string Title, Func<Task> Action, Func<bool> Condition)>
        {
            ...
            (@"Setting ""Latency sensitivity hint min unparked cores/packages"" to 100%", async () => PowerApi.PowerWriteDCValueIndex(IntPtr.Zero, PowerApi.AllocGuid(guid), PowerApi.AllocGuid(new Guid("54533251-82be-4824-96c1-47b60b740d00")), PowerApi.AllocGuid(new Guid("616cdaa5-695e-4545-97ad-97dc2d1bdd88")), 100), null),
            ...
            (@"Setting ""Latency sensitivity hint min unparked cores/packages for Processor Power Efficiency Class 1"" to 100%", async () => PowerApi.PowerWriteDCValueIndex(IntPtr.Zero, PowerApi.AllocGuid(guid), PowerApi.AllocGuid(new Guid("54533251-82be-4824-96c1-47b60b740d00")), PowerApi.AllocGuid(new Guid("616cdaa5-695e-4545-97ad-97dc2d1bdd89")), 100), null),
            ...
            (@"Setting ""Latency sensitivity hint processor performance"" to 100%", async () => PowerApi.PowerWriteDCValueIndex(IntPtr.Zero, PowerApi.AllocGuid(guid), PowerApi.AllocGuid(new Guid("54533251-82be-4824-96c1-47b60b740d00")), PowerApi.AllocGuid(new Guid("619b7505-003b-4e82-b7a6-4dd29c300971")), 100), null),
            ...
            (@"Setting ""Latency sensitivity hint processor performance for Processor Power Efficiency Class 1"" to 100%", async () => PowerApi.PowerWriteDCValueIndex(IntPtr.Zero, PowerApi.AllocGuid(guid), PowerApi.AllocGuid(new Guid("54533251-82be-4824-96c1-47b60b740d00")), PowerApi.AllocGuid(new Guid("619b7505-003b-4e82-b7a6-4dd29c300972")), 100), null),
            ...
            (@"Setting ""Processor autonomous activity window"" to 0", async () => PowerApi.PowerWriteDCValueIndex(IntPtr.Zero, PowerApi.AllocGuid(guid), PowerApi.AllocGuid(new Guid("54533251-82be-4824-96c1-47b60b740d00")), PowerApi.AllocGuid(new Guid("cfeda3d0-7697-4566-a922-a9086cd49dfa")), 0), null),
            ...
            (@"Setting ""Processor idle demote threshold"" to 1", async () => PowerApi.PowerWriteDCValueIndex(IntPtr.Zero, PowerApi.AllocGuid(guid), PowerApi.AllocGuid(new Guid("54533251-82be-4824-96c1-47b60b740d00")), PowerApi.AllocGuid(new Guid("4b92d758-5a24-4851-a470-815d78aee119")), 1), null),
            ...
            (@"Setting ""Processor idle promote threshold"" to 0", async () => PowerApi.PowerWriteDCValueIndex(IntPtr.Zero, PowerApi.AllocGuid(guid), PowerApi.AllocGuid(new Guid("54533251-82be-4824-96c1-47b60b740d00")), PowerApi.AllocGuid(new Guid("7b224883-b3cc-4d79-819f-8374152cbe7c")), 0), null),
            ...
            (@"Setting ""Processor idle time check"" to 200000", async () => PowerApi.PowerWriteDCValueIndex(IntPtr.Zero, PowerApi.AllocGuid(guid),PowerApi.AllocGuid(new Guid("54533251-82be-4824-96c1-47b60b740d00")), PowerApi.AllocGuid(new Guid("c4581c31-89ab-4597-8e2b-9c9cab440e6b")), 200000), null),
            ...
            (@"Disabling ""Processor performance autonomous mode""", async () => PowerApi.PowerWriteDCValueIndex(IntPtr.Zero, PowerApi.AllocGuid(guid), PowerApi.AllocGuid(new Guid("54533251-82be-4824-96c1-47b60b740d00")), PowerApi.AllocGuid(new Guid("8baa4a8a-14c6-4451-8e8b-14bdbd197537")), 0), null),
            ...
            (@"Setting ""Processor performance core parking concurrency headroom threshold"" to 100", async () => PowerApi.PowerWriteDCValueIndex(IntPtr.Zero, PowerApi.AllocGuid(guid), PowerApi.AllocGuid(new Guid("54533251-82be-4824-96c1-47b60b740d00")), PowerApi.AllocGuid(new Guid("f735a673-2066-4f80-a0c5-ddee0cf1bf5d")), 100), null),
            ...
            (@"Setting ""Processor performance core parking concurrency threshold"" to 100", async () => PowerApi.PowerWriteDCValueIndex(IntPtr.Zero, PowerApi.AllocGuid(guid), PowerApi.AllocGuid(new Guid("54533251-82be-4824-96c1-47b60b740d00")), PowerApi.AllocGuid(new Guid("2430ab6f-a520-44a2-9601-f7f23b5134b1")), 100), null),
            ...
            (@"Setting ""Short running threads' processor architecture upper limit"" to 0", async () => PowerApi.PowerWriteDCValueIndex(IntPtr.Zero, PowerApi.AllocGuid(guid), PowerApi.AllocGuid(new Guid("54533251-82be-4824-96c1-47b60b740d00")), PowerApi.AllocGuid(new Guid("828423eb-8662-4344-90f7-52bf15870f5a")), 0), null),
