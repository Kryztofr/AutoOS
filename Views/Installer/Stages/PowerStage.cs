...
public static class PowerStage
{
    public static List<(string Title, Func<Task> Action, Func<bool> Condition)> GetActions()
    {
        ...
        return new List<(string Title, Func<Task> Action, Func<bool> Condition)>
        {
            ...
            (@"Setting ""Heterogeneous short running thread scheduling policy"" to ""Automatic""", async () => PowerApi.WriteACValueIndex(guid, new Guid("54533251-82be-4824-96c1-47b60b740d00"), new Guid("bae08b81-2d5e-4688-ad6a-13243356654b"), 5), null),
            (@"Setting ""Heterogeneous short running thread scheduling policy"" to ""Automatic""", async () => PowerApi.WriteDCValueIndex(guid, new Guid("54533251-82be-4824-96c1-47b60b740d00"), new Guid("bae08b81-2d5e-4688-ad6a-13243356654b"), 5), null),
